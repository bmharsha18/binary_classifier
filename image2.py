...
temp = os.listdir("/home/harshabm/Documents/Placements/Projects/Neural Network/Untitled Folder/test_64/")
y = list()

for i in range(len(temp)):
    print(i)
    s = temp[i]
    pic = Image.open("/home/harshabm/Documents/Placements/Projects/Neural Network/Untitled Folder/test_64/"+str(s))
